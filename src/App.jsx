...
export default function App() {
  ...
  return (
    <div style={{ background:T.bg, minHeight:"100vh", color:T.text, fontFamily:"'Syne','Trebuchet MS',sans-serif" }}>
      ...
      <div style={{ background:"linear-gradient(160deg,#0a0f1e 0%,#0d1829 50%,#0a1428 100%)", borderBottom:`1px solid ${T.border}`, padding:"28px 20px 0" }}>
        <div style={{ maxWidth:700, margin:"0 auto" }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:20 }}>
            <div>
              <p style={{ margin:"0 0 4px", fontSize:10, color:T.accent, letterSpacing:3, textTransform:"uppercase" }}>Wealth Tracker Pro</p>
              <h1 style={{ margin:"0 0 4px", fontSize:24, fontWeight:800, letterSpacing:-0.5 }}>My Portfolio</h1>
